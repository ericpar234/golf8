         ...
         sspr(sx, sy, 8, 8, dx, dy, tile_draw_w, tile_draw_h)
				...
				if swing_mode == "scoreboard" then
					  ...
					  for h=1, #hole_locations do
									...
									print("hole "..h..": "..score.." ("..par..")", 1, 8 + (h-1) * 8, 7)
					  end
							print("total: "..total.." "..ou.."", 1, 8 + (#hole_locations) * 8, 7)
							print("❎", 63, 120, 7)
							return
				end
...

...

